...
function PrivacyPolicy({ setPage }) {
    ...
    return (
        <div className='privacy-policy-box' id="main-content">
            <div className='policy-back-to-home-box'>
                <button
                    className='policy-back-to-home-btn'
                    onClick={(e) => {
                        e.preventDefault();
                        setPage('HOME');
                    }}>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Qian Li.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Qian Li, accessible from http://www.qianli.com</p>
                </li>
                <li>
            ...
            <li className='end'>By email: 2qianli.com@gmail.com</li>
        </div >
    )
}
